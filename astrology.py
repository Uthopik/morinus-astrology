...
# --- FORZAR CONEXIÓN CON EL ADAPTADOR ---
import sweastrology

# Redirigimos las funciones críticas hacia tus versiones con "Voto"
swe_calc = sweastrology.swe_calc_adaptado
swe_calc_ut = sweastrology.swe_calc_ut_adaptado
swe_houses_ex = sweastrology.swe_houses_ex_adaptado
# ----------------------------------------

def swe_get_ayanamsa_ut(tjd_ut):
    import swisseph as swe
    # En Ubuntu 20, pyswisseph suele usar este nombre:
    return swe.get_ayanamsa_ut(tjd_ut)
