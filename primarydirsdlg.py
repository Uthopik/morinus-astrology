...
class PrimDirsDlg(wx.Dialog):
	def __init__(self, parent, options, ephepath):
		# Inicialización directa y moderna para wxPython en Ubuntu 20
		wx.Dialog.__init__(self, parent, -1, mtexts.txts['PrimaryDirs'], style=wx.DEFAULT_DIALOG_STYLE | wx.DIALOG_EX_CONTEXTHELP)
		
		# Eliminamos las líneas de 'pre' y 'PostCreate' que daban error
