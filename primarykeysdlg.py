...
class PrimaryKeysDlg(wx.Dialog):
	...
	def __init__(self, parent, options):
		# Inicialización directa para evitar el error de 'pre'
		wx.Dialog.__init__(self, parent, -1, mtexts.txts['PrimaryKeys'], style=wx.DEFAULT_DIALOG_STYLE | wx.DIALOG_EX_CONTEXTHELP)
