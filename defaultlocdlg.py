...
class DefaultLocDlg(wx.Dialog):
	...
	def __init__(self, parent, langid):
		self.langid = langid
		# Inicialización limpia para Ubuntu 20
		wx.Dialog.__init__(self, parent, -1, mtexts.txts['DefaultLocation'], style=wx.DEFAULT_DIALOG_STYLE | wx.DIALOG_EX_CONTEXTHELP)
...
#		fgsizer.AddGrowableCol(4, 0)
		...
		vvsizer.Add(self.zhour, 0, wx.LEFT, 5)
		fgsizer.Add(vvsizer, 0, wx.ALIGN_LEFT|wx.ALL, 5)
		vvsizer = wx.BoxSizer(wx.VERTICAL)
