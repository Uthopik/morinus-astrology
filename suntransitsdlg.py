...
class SunTransitsDlg(wx.Dialog):
	def __init__(self, parent):
		# Sustitución de pre-create por constructor directo
		wx.Dialog.__init__(self, parent, -1, mtexts.txts['SunTransits'], pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE)
		
		if hasattr(wx, 'SetExtraStyle'):
		...
		# Parche FlexGridSizer (2 filas, 3 columnas, espaciado 0, 0)
	...
	def initialize(self, chrt):
		year, month, day = util.incrDay(chrt.time.year, chrt.time.month, chrt.time.day)
		self.ascrb.SetFocus()
