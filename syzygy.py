...
class Syzygy:
	...
	def __init__(self, chrt):
		...
		if not chrt.time.bc:
			...
			hses = houses.Houses(self.time.jd, 0, chrt.place.lat, chrt.place.lon, chrt.options.hsys, chrt.obl, chrt.options.ayanamsha, chrt.ayanamsha)
		...
		ra, decl, dist = astrology.swe_cotrans(self.lon, 0.0, 1.0, -chrt.obl)
		...
		if not chrt.time.bc:
			...
			hses2 = houses.Houses(self.time2.jd, 0, chrt.place.lat, chrt.place.lon, chrt.options.hsys, chrt.obl, chrt.options.ayanamsha, chrt.ayanamsha)
			...
			ra2, decl2, dist2 = astrology.swe_cotrans(self.lon2, 0.0, 1.0, -chrt.obl)
