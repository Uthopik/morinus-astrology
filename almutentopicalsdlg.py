...
class AlmutenTopicalsDlg(wx.Dialog):
	...
	def __init__(self, parent, opts):
		# CAMBIO: Inicialización directa para evitar el NameError 'pre'
		wx.Dialog.__init__(self, parent, -1, mtexts.txts['TopicalAlmutens'], 
		...
		# ComboBox de nombres
		self.namescb = wx.ComboBox(self, -1, '', size=(230, -1), choices=self.namestxt, style=wx.CB_DROPDOWN|wx.CB_READONLY)
		if self.namestxt:
		...
		# Combos de configuración de filas
		COMBOSIZE = 160
		hsizer = wx.BoxSizer(wx.HORIZONTAL)
