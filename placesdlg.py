...
class PlacesDlg(wx.Dialog):
	...
	def __init__(self, parent, langid):#, inittxt):
		...
		#Place
		fgsizer = wx.FlexGridSizer(rows=2, cols=4, vgap=0, hgap=0)
...
#		return False
	...
	def onOK(self, event):
		self.li.save() # Esto ahora funcionará (o fallará en silencio sin Traceback)
		self.EndModal(wx.ID_OK) # ESTA LÍNEA ES LA QUE CIERRA Y PASA LOS DATOS
